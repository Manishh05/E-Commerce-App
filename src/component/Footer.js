   ...
   <div className="container-xxl">
     ...
     <div>
      <address className='text-white'>
       Hno: 4/A Palayamkottai , Tirunelveli <br /> 67200 TamilNadu
      </address>
      <a href="tel:+33 005765361" className="mt-4 text-white d-block mb-3">+91 8056357461</a>
      <a href="mailto: piercel.coder2022@gmail.com" className="mt-4 text-white d-block mb-3">marcmaniix05@gmail.com</a>
      <div className="social-icons d-flex align-items-center gap-30 justify-content-between mb-5">
        <a 
        className='text-white fs-5'  href="https://linkedin.com">
          <BsLinkedin  />
        </a>
       
        <a 
         className='text-white fs-5'   href="https://github.com">
         <BsGithub  />
        </a>
       
        <a 
        className='text-white fs-5'  href="https://youtube.com">
        <BsYoutube  />
        </a>
        
        <a 
        className='text-white fs-5'   href="https://instagram.com">
           <BsInstagram />
        </a>
      </div>
     </div>
